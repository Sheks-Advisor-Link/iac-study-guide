...
set -euo pipefail
cd "$(dirname "$0")"
for src in IAC-Study-Guide Substantive-Procedures IAC-Tax-Summary IAC-Tax-RateCard IAC-Tax-Rules-and-Principles IAC-Tax-Corporate-Rules IAC-Tax-Double-Tax-Agreements IAC-Tax-Employee-Benefits IAC-ACC-Control-Interests IAC-AUD-Comprehensive IAC-ACC-IFRS-Summary IAC-ACC-IFRS15-Control IAC-ACC-MindMaps IAC-ACC-IFRS3-PartOfCombination IAC-MAF-Discussion-Factors IAC-AUD-Exam-Master IAC-AUD-Audit-Strategy-NTE IAC-ACC-IAS12-DeferredTax IAC-Tax-Deceased-Estate IAC-AUD-Going-Concern IAC-Jan2026-Question-Summary
  [ -f "$src.html" ] || continue
